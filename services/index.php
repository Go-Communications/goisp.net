...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- Favicons -->
  <link href="https://goisp.net/img/go/goisp-logo-40-40-px.svg" rel="icon">
  <link href="https://goisp.net/img/go/goisp-logo-40-40-px.svg" rel="apple-touch-icon">
    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="https://goisp.net/security">Security</a></li>
          <li><a href="https://goisp.net/https://goisp.net/learning">Education</a></li>
          <li><a href="https://goisp.net/jobs">Jobs</a></li>
          <li><a href="https://goisp.net/media">Media</a></li>
          <li><a href="https://goisp.net/investors.php">Investors</a></li>
          <li><a href="https://goisp.net/#about">Abohttps://goisp.net/ut Us</a></li>
          <li><a href="https://goisp.net/#contact">Contact Us</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              <img src="https://goisp.net/img/team-2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Masud Parvez</h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><a href="https://goisp.net/jobs/reporting/">Reporting</a></li>
              <li><a href="https://goisp.net/media">Media</a></li>
