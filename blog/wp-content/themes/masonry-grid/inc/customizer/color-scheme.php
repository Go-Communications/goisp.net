...
$wp_customize->add_setting(
    'masonry_grid_premium_notiece_color_schema',
    array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
...
$wp_customize->add_control(
    new Masonry_Grid_Premium_Notiece_Control( 
        $wp_customize,
        'masonry_grid_premium_notiece_color_schema',
        array(
            'label'      => esc_html__( 'Color Schemes', 'masonry-grid' ),
            'settings' => 'masonry_grid_premium_notiece_color_schema',
            'section'       => 'color_scheme',
        )
    )
);
...
$wp_customize->add_setting(
    'masonry_grid_premium_notiece_color',
    array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field'
...
$wp_customize->add_control(
    new Masonry_Grid_Premium_Notiece_Control( 
        ...
        array(
            ...
            'settings' => 'masonry_grid_premium_notiece_color',
            'section'       => 'colors',
        )
    )
);