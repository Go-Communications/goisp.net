...
if( $masonry_grid_ed_post_like_dislike ){ masonry_grid_disable_post_like_dislike(); }
if( $masonry_grid_ed_post_author_box ){ masonry_grid_disable_post_author_box(); }
if( $masonry_grid_ed_post_reaction ){ masonry_grid_disable_post_reaction(); }
?>
