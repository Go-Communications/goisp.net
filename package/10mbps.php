...
<!-- Load Facebook SDK for JavaScript -->
  ...
  ============================-->
    ...
    <section id="about" class="clearfix">
      ...
      <h2> 10 MBPS Internet Package</h2>
      
      <p>10 Mbps internet package is designed for the user need steady internet connectivity for home and families. This package is combined with 8 mbits internet, 100 Mbits Facebook and 100 Mbits youtube. If you need family users internet packages to use 3 to 4 members of a single family, this package is best for them. </p>
      
      <br>
      <img src="img/10mbps.png" alt="" class="img-fluid" width="150px">
      <br>
      
      <h3>Package description</h3>
      
      <p>
          1. Internet speed 10 Mbits <br>
          2. Facebook speed 100 Mbits <br>
          3. YouTube speed 100 Mbits <br>
          4. FTP movies - Yes <br>
          5. IP TV - Yes <br>
    ...
    <h4>10 Mbps package price</h4>
    <p>Price BDT 900 TK.</p>
