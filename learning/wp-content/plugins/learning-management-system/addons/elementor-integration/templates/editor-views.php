...
<script type="text/template" id="tmpl-masteriyo-single-course-page-preview">
	<img src="<?php echo esc_url( masteriyo_get_plugin_url() . '/addons/elementor-integration/img/single-course-page-preview.png' ); ?>" width="100%">
</script>

<script type="text/template" id="tmpl-masteriyo-course-archive-page-preview">
	<img src="<?php echo esc_url( masteriyo_get_plugin_url() . '/addons/elementor-integration/img/course-archive-page-preview.png' ); ?>" width="100%">
</script>
