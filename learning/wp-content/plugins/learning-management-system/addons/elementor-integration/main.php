	...
	add_action(
		...
		function() {
			printf(
				...
				esc_html( 'Masteriyo:' ),
				wp_kses_post( 'Elementor Integration addon requires Elementor to be installed and activated.', 'masteriyo' ),
...
if ( ! Helper::is_elementor_active() ) {
	add_filter(
		...
		function ( $result, $request, $controller ) {
			$result = __( 'Elementor is to be installed and activated for this addon to work properly', 'masteriyo' );
			return $result;
		},
		10,
		3
